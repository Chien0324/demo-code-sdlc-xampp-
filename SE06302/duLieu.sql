...
INSERT INTO Grades (id, user_id, username, gender,course_id, name, score) 
VALUES
...
INSERT INTO schedule (id, birth_date, class, start_time, end_time, courses_id, name, activity) 
VALUES
...
INSERT INTO requests (id, user_id, username, courses_id, name, request_text) 
VALUES 
    (1,1,'Do Ngoc trung',1,'HTML Basics', 'Recover attendance that was missed due to absence.'),
    (2,2,'Hoang Van Trung',5, 'Responsive Web Design', 'Automatically record attendance in online classes.'),
    (3,9,'Vo Thi Hong', 10,'Project Management', 'Check and adjust attendance for past classes.'),
    (4,2,'Nguyen Van Anh',10, 'Project Management', 'Notify students about missing attendance and how to restore it.'),
    (5,5,'Pham Thi Minh', 6,'SQL and Databases', ' Instructor to verify attendance if the student has a valid excuse.');
